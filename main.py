...
def generate_report_endpoint(start_date: Optional[str] = Query(None), end_date: Optional[str] = Query(None)):
    ...
    try:
        ...
        if(start_date > datetime.utcnow() and end_date > datetime.utcnow()):
